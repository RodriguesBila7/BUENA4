...
app.use('/api/admin-acts',    requireAuth, adminActsRouter);
app.use('/api/act-types',     requireAuth, actTypesRouter);
app.use('/api/audit',         requireAuth, auditRouter);
app.use('/api/disciplinary',  requireAuth, createGenericRouter('disciplinary'));
app.use('/api/transfers',     requireAuth, createGenericRouter('transfers'));
app.use('/api/evaluations',   requireAuth, createGenericRouter('evaluations'));
app.use('/api/effectiveness', requireAuth, createGenericRouter('effectiveness'));
