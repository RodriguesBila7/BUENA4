...
const styles = {
  ...
  selectedEmp: { padding: '12px 16px', backgroundColor: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'var(--color-text-base, #1e40af)', fontSize: '13px' },
  changeBtn: { padding: '4px 10px', borderRadius: '6px', backgroundColor: 'var(--color-bg-subtle, #fff)', border: '1px solid rgba(59, 130, 246, 0.3)', color: '#3B82F6', cursor: 'pointer', fontWeight: '600', fontSize: '12px' },
  ...
  radioSelectedDanger: { flex: 1, padding: '10px', textAlign: 'center', borderRadius: '8px', border: '2px solid #EF4444', backgroundColor: 'rgba(239, 68, 68, 0.1)', cursor: 'pointer', fontWeight: '700', color: '#ef4444', fontSize: '13px' },
  alertDanger: { padding: '10px 14px', backgroundColor: 'rgba(239, 68, 68, 0.15)', borderLeft: '4px solid #EF4444', color: '#ef4444', borderRadius: '4px', fontSize: '12px', marginTop: '6px' },
  errorAlert: { padding: '10px 14px', backgroundColor: 'rgba(239, 68, 68, 0.15)', border: '1px solid rgba(239, 68, 68, 0.3)', color: '#ef4444', borderRadius: '8px', fontSize: '13px', fontWeight: '500' },
  ...
  btnCancel: { padding: '8px 16px', borderRadius: '6px', border: '1px solid var(--color-border, #cbd5e1)', backgroundColor: 'var(--color-bg-subtle, #fff)', color: 'var(--color-text-base, #1e293b)', fontWeight: '600', cursor: 'pointer', fontSize: '13px' },
  btnSubmit: { padding: '8px 18px', borderRadius: '6px', border: 'none', backgroundColor: 'var(--color-primary, #DC2626)', color: '#fff', fontWeight: '600', cursor: 'pointer', fontSize: '13px', boxShadow: '0 2px 4px rgba(220, 38, 38, 0.2)' },
  resizeHandle: {
    position: 'absolute',
    bottom: 2,
    right: 2,
