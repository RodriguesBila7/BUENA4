...
const styles = {
  ...
  title: { margin: 0, fontSize: '15px', fontWeight: '600', color: 'var(--color-text-main, #0f172a)', letterSpacing: '-0.2px' },
  expandBtn: {
  ...
  closeBtn: { background: 'none', border: 'none', fontSize: '18px', cursor: 'pointer', color: 'var(--color-text-muted, #94a3b8)', padding: '2px 8px', borderRadius: '6px' },
  body: { padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: '12px', flex: 1, overflowY: 'auto', boxSizing: 'border-box' },
  message: { margin: 0, fontSize: '13.5px', color: 'var(--color-text-base, #334155)', lineHeight: '1.5' },
  modalInput: {
    width: '100%',
    minHeight: '75px',
    padding: '8px 12px',
